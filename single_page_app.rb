...
# require "../bellsandwhistles-auto.rb"
require "/Users/zpalmer/Documents/API/treebrain-integrations/bellsandwhistles/bellsandwhistles-auto.rb"
...
# class SinglePageApp < Sinatra::Base
    ...
    get '/' do
        ...
        erb :bellsandwhistlessinglepagecheckout
    ...
    post '/create_transaction' do
        ...
        erb :bellsandwhistlessinglepagecheckoutresult
